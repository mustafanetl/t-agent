...
### 3) Clone repo (keep the repo in place)
```bash
...
```
Do **not** move files out of the repo folder. Keep the repo root as your working directory.
...
### 2) Bootstrap the VM (run directly on the VM)
```bash
cd ~
